...
class medication:
    name = frame("Your medication is called Metformin.", "What is the name of your medication?", ["Metformin"])
    purpose = frame("It is used to treat type 2 diabetes by helping to control the amount of sugar in your blood.", "How does your medication treat your diabetes?", ["By controlling the amount of sugar in my blood."])
    ...
    dose = frame("Take one tablet of Metformin by mouth", "How many tablets should you take each time?", ["One tablet"])
    frequency = frame("Take your medicine two times a day, with breakfast and with dinner. Swallow the table whole.", "How many times should you take the medicine in one day?", ["Two", "twice"])
